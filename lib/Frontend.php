...
class Frontend extends ApiFrontend {
    function init(){
        ...
        $this->add('Menu',null,'Menu')
            ...
            ->addMenuItem('customer','CUSTOMER ENQUIRY')
            ->addMenuItem('project ','PROJECT')
            ->addMenuItem('complaint','COMPLAINTS')
            ->addMenuItem('followup','FOLLOW Ups!')
            // ->addMenuItem('learnview','Learn!')
            ;
